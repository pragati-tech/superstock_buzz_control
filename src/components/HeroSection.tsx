...
const HeroSection = () => {
  return (
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        {/* Enhanced Subtitle */}
        <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in font-light">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-6 max-w-3xl mx-auto">
